...
;// CONCATENATED MODULE: ./assets/js/utilities.js
...
function syncElementsHeight($elements) {
...
;// CONCATENATED MODULE: ./assets/js/components/sectionNav.js
...
;// CONCATENATED MODULE: ./assets/js/components/sectionRerender.js
...
;// CONCATENATED MODULE: ./assets/js/components/index.js



;// CONCATENATED MODULE: ./assets/js/utilities/inlineToggle.js
...
;// CONCATENATED MODULE: ./assets/js/utilities/deactivate.js
...
;// CONCATENATED MODULE: ./assets/js/accordion.js
...
;// CONCATENATED MODULE: ./assets/js/audioTrigger.js
// audioTrigger.js
...
/* harmony default export */ const audioTrigger = (AudioTrigger);

;// CONCATENATED MODULE: ./assets/js/backInStock.js
...
/* harmony default export */ const backInStock = (BackInStock);

;// CONCATENATED MODULE: ./assets/js/blendComponents.js
...
/* harmony default export */ const blendComponents = (BlendComponents);

;// CONCATENATED MODULE: ./assets/js/cart.js
...
;// CONCATENATED MODULE: ./assets/js/collectionNav.js
...
/* harmony default export */ const js_collectionNav = (collectionNav);

;// CONCATENATED MODULE: ./assets/js/customerAddresses.js
...
/* harmony default export */ const customerAddresses = (CustomerAddresses);

;// CONCATENATED MODULE: ./assets/js/customSelect.js
...
;// CONCATENATED MODULE: ./assets/js/customSelectInit.js
...
/* harmony default export */ const filterOptions = (FilterOptionList);

;// CONCATENATED MODULE: ./assets/js/giftSubscription.js
...
/* harmony default export */ const giftSubscription = (GiftSubscription);

;// CONCATENATED MODULE: ./assets/js/marquee.js
...
;// CONCATENATED MODULE: ./assets/js/menu/megaMenu.js
...
;// CONCATENATED MODULE: ./assets/js/menu/mobileMegaMenu.js
...
/* harmony default export */ const mobileMegaMenu = (MobileMegaMenu);

;// CONCATENATED MODULE: ./assets/js/menu/announcementBar.js
...
/* harmony default export */ const announcementBar = (AnnouncementBar);

;// CONCATENATED MODULE: ./assets/js/menu/menu.js
...
;// CONCATENATED MODULE: ./assets/js/pagination.js
...
;// CONCATENATED MODULE: ./assets/js/predictiveSearch.js
...
/* harmony default export */ const predictiveSearch = (PredictiveSearch);

;// CONCATENATED MODULE: ./assets/js/productBuyPanel.js
...
/* harmony default export */ const productBuyPanel = (ProductBuyPanel);

;// CONCATENATED MODULE: ./assets/js/productCard.js
...
/* harmony default export */ const productRecommendations = (ProductRecommendations);

;// CONCATENATED MODULE: ./assets/js/quantityBox.js
...
/* harmony default export */ const quantityBox = (QuantityBox);
...
// EXTERNAL MODULE: ./node_modules/@accessible360/accessible-slick/slick/slick.js
var slick = __webpack_require__(475);
;// CONCATENATED MODULE: ./assets/js/slider.js
...
;// CONCATENATED MODULE: ./assets/js/video.js
...
const GriListSwitch = (function(){
    ...
    const gridListLayoutSwitch = function(){
        dist_jquery_default()('.layout-switch-btn').on('click', function(){
            dist_jquery_default()(this).addClass('switch__active')
            dist_jquery_default()(this).siblings().removeClass('switch__active');
        
            let currentViewSelected = dist_jquery_default()(this).attr('data-switch')

            dist_jquery_default()('.js-collection-list.collection-grid--container').animate({opacity: 0}, 400)
        
            if(currentViewSelected == 'list'){
               
               setTimeout(function(){
                dist_jquery_default()('.js-collection-list.collection-grid--container').animate({opacity: 1}, 400)
                dist_jquery_default()('.js-collection-list.collection-grid--container').addClass('list-view-active')
                dist_jquery_default()('.js-collection-list.collection-grid--container').children('ul').addClass('grid-cols-1').removeClass('xl:grid-cols-3') 
                ...
                setTimeout(function(){
                dist_jquery_default()('.js-collection-list.collection-grid--container').animate({opacity: 1}, 400)
                dist_jquery_default()('.js-collection-list.collection-grid--container').removeClass('list-view-active')
                dist_jquery_default()('.js-collection-list.collection-grid--container').children('ul').removeClass('grid-cols-1').addClass('xl:grid-cols-3')
                }, 400)
            }  
        })
    }
